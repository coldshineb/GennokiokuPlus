...
import city.gennokioku.plus.util.DiscordEventHandlers;
import city.gennokioku.plus.util.DiscordRPC;
import city.gennokioku.plus.util.DiscordRichPresence;
...
public class DiscordClient implements Closeable {
    ...
    public DiscordClient() {
        try {
            ...
            discordRpc.Discord_Initialize("811080997905891368", handlers, true, null);
