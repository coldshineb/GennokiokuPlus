...
public class Line1Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_1")
	public static final Block block = null;

	public Line1Block(GennokiokuPlusElements instance) {
		super(instance, 1);
	}
