...
public class Line2Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_2")
	public static final Block block = null;

	public Line2Block(GennokiokuPlusElements instance) {
		super(instance, 2);
	}
