...
public class Line4Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_4")
	public static final Block block = null;

	public Line4Block(GennokiokuPlusElements instance) {
		super(instance, 4);
	}
