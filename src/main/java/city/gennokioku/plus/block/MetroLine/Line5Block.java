...
public class Line5Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_5")
	public static final Block block = null;

	public Line5Block(GennokiokuPlusElements instance) {
		super(instance, 5);
	}
