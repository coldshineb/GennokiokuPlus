...
public class Line7Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_7")
	public static final Block block = null;

	public Line7Block(GennokiokuPlusElements instance) {
		super(instance, 7);
	}
