...
public class Line9Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_9")
	public static final Block block = null;

	public Line9Block(GennokiokuPlusElements instance) {
		super(instance, 9);
	}
