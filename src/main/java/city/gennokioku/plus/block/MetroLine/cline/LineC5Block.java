...
package city.gennokioku.plus.block.MetroLine.cline;
...
public class LineC5Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_c5")
	public static final Block block = null;

	public LineC5Block(GennokiokuPlusElements instance) {
		super(instance, 131);
	}
