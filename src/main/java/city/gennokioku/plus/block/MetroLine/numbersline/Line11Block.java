...
public class Line11Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_11")
	public static final Block block = null;

	public Line11Block(GennokiokuPlusElements instance) {
		super(instance, 122);
	}
