...
public class Line13Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_13")
	public static final Block block = null;

	public Line13Block(GennokiokuPlusElements instance) {
		super(instance, 124);
	}
