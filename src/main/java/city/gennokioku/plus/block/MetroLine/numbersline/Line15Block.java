...
public class Line15Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_15")
	public static final Block block = null;

	public Line15Block(GennokiokuPlusElements instance) {
		super(instance, 125);
	}
