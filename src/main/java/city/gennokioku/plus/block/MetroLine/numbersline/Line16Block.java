...
public class Line16Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_16")
	public static final Block block = null;

	public Line16Block(GennokiokuPlusElements instance) {
		super(instance, 126);
	}
