...
public class Line17Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_17")
	public static final Block block = null;

	public Line17Block(GennokiokuPlusElements instance) {
		super(instance, 127);
	}
