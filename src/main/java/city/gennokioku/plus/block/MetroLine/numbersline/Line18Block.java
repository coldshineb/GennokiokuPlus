...
public class Line18Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_18")
	public static final Block block = null;

	public Line18Block(GennokiokuPlusElements instance) {
		super(instance, 128);
	}
