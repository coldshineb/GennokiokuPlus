...
public class Line20Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_20")
	public static final Block block = null;

	public Line20Block(GennokiokuPlusElements instance) {
		super(instance, 129);
	}
