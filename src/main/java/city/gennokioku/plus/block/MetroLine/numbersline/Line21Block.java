...
public class Line21Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_21")
	public static final Block block = null;

	public Line21Block(GennokiokuPlusElements instance) {
		super(instance, 130);
	}
