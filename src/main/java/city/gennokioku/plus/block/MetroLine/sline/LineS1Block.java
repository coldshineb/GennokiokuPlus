...
public class LineS1Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_s1")
	public static final Block block = null;

	public LineS1Block(GennokiokuPlusElements instance) {
		super(instance, 135);
	}
