...
public class LineS2Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_s2")
	public static final Block block = null;

	public LineS2Block(GennokiokuPlusElements instance) {
		super(instance, 136);
	}
