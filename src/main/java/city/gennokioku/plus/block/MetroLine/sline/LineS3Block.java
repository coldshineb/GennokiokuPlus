...
package city.gennokioku.plus.block.MetroLine.sline;
...
public class LineS3Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_s3")
	public static final Block block = null;

	public LineS3Block(GennokiokuPlusElements instance) {
		super(instance, 137);
	}
