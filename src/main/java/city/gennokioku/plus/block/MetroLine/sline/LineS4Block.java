...
public class LineS4Block extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_s4")
	public static final Block block = null;

	public LineS4Block(GennokiokuPlusElements instance) {
		super(instance, 138);
	}
