...
public class LineLCBlock extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_lc")
	public static final Block block = null;

	public LineLCBlock(GennokiokuPlusElements instance) {
		super(instance, 12);
	}
