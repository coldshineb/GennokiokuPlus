...
public class LineLLBlock extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_ll")
	public static final Block block = null;

	public LineLLBlock(GennokiokuPlusElements instance) {
		super(instance, 132);
	}
