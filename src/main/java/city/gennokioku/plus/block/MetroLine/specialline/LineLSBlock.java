...
package city.gennokioku.plus.block.MetroLine.specialline;
...
public class LineLSBlock extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:line_ls")
	public static final Block block = null;

	public LineLSBlock(GennokiokuPlusElements instance) {
		super(instance, 134);
	}
