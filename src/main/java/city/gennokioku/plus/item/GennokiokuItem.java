...
public class GennokiokuItem extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("gennokiokuplus:gennokioku")
	public static final Item block = null;

	public GennokiokuItem(GennokiokuPlusElements instance) {
		super(instance, 13);
	}
