...
public class StomtCraftItem extends GennokiokuPlusElements.ModElement {
	@ObjectHolder("stomtcraftplus:stomt_craft")
	public static final Item block = null;

	public StomtCraftItem(GennokiokuPlusElements instance) {
		super(instance, 13);
	}
