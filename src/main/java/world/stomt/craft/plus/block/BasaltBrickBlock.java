...
public class BasaltBrickBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:basalt_brick")
	public static final Block block = null;
	public BasaltBrickBlock(StomtcraftplusModElements instance) {
		super(instance, 75);
	}
