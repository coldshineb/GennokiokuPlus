...
public class BasaltCircleBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:basalt_circle")
	public static final Block block = null;
	public BasaltCircleBlock(StomtcraftplusModElements instance) {
		super(instance, 76);
	}
