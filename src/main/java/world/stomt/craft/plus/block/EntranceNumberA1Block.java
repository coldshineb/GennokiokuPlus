...
public class EntranceNumberA1Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_a_1")
	public static final Block block = null;
	public EntranceNumberA1Block(StomtcraftplusModElements instance) {
		super(instance, 89);
	}
