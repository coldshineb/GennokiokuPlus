...
public class EntranceNumberA2Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_a_2")
	public static final Block block = null;
	public EntranceNumberA2Block(StomtcraftplusModElements instance) {
		super(instance, 90);
	}
