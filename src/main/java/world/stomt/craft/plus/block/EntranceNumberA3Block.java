...
public class EntranceNumberA3Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_a_3")
	public static final Block block = null;
	public EntranceNumberA3Block(StomtcraftplusModElements instance) {
		super(instance, 91);
	}
