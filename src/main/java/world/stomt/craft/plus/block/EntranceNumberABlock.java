...
public class EntranceNumberABlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_a")
	public static final Block block = null;
	public EntranceNumberABlock(StomtcraftplusModElements instance) {
		super(instance, 88);
	}
