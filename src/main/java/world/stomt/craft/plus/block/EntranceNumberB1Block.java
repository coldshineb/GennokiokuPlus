...
public class EntranceNumberB1Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_b_1")
	public static final Block block = null;
	public EntranceNumberB1Block(StomtcraftplusModElements instance) {
		super(instance, 93);
	}
