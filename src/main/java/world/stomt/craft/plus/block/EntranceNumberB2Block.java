...
public class EntranceNumberB2Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_b_2")
	public static final Block block = null;
	public EntranceNumberB2Block(StomtcraftplusModElements instance) {
		super(instance, 94);
	}
