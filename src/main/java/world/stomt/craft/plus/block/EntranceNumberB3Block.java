...
public class EntranceNumberB3Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_b_3")
	public static final Block block = null;
	public EntranceNumberB3Block(StomtcraftplusModElements instance) {
		super(instance, 95);
	}
