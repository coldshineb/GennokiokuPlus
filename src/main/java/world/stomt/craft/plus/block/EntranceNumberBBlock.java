...
public class EntranceNumberBBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_b")
	public static final Block block = null;
	public EntranceNumberBBlock(StomtcraftplusModElements instance) {
		super(instance, 92);
	}
