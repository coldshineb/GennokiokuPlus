...
public class EntranceNumberC1Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_c_1")
	public static final Block block = null;
	public EntranceNumberC1Block(StomtcraftplusModElements instance) {
		super(instance, 97);
	}
