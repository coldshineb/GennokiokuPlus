...
public class EntranceNumberC2Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_c_2")
	public static final Block block = null;
	public EntranceNumberC2Block(StomtcraftplusModElements instance) {
		super(instance, 98);
	}
