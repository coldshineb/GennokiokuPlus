...
public class EntranceNumberC3Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_c_3")
	public static final Block block = null;
	public EntranceNumberC3Block(StomtcraftplusModElements instance) {
		super(instance, 99);
	}
