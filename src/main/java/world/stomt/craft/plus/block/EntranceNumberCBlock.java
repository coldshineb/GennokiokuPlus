...
public class EntranceNumberCBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_c")
	public static final Block block = null;
	public EntranceNumberCBlock(StomtcraftplusModElements instance) {
		super(instance, 96);
	}
