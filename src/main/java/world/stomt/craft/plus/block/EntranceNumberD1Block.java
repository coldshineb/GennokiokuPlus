...
public class EntranceNumberD1Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_d_1")
	public static final Block block = null;
	public EntranceNumberD1Block(StomtcraftplusModElements instance) {
		super(instance, 101);
	}
