...
public class EntranceNumberD3Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_d_3")
	public static final Block block = null;
	public EntranceNumberD3Block(StomtcraftplusModElements instance) {
		super(instance, 103);
	}
