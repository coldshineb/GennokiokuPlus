...
public class EntranceNumberDBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_d")
	public static final Block block = null;
	public EntranceNumberDBlock(StomtcraftplusModElements instance) {
		super(instance, 100);
	}
