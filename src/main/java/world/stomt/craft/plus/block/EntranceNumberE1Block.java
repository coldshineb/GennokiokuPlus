...
public class EntranceNumberE1Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_e_1")
	public static final Block block = null;
	public EntranceNumberE1Block(StomtcraftplusModElements instance) {
		super(instance, 105);
	}
