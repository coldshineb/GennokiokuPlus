...
public class EntranceNumberE2Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_e_2")
	public static final Block block = null;
	public EntranceNumberE2Block(StomtcraftplusModElements instance) {
		super(instance, 106);
	}
