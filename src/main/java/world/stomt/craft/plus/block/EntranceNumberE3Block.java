...
public class EntranceNumberE3Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_e_3")
	public static final Block block = null;
	public EntranceNumberE3Block(StomtcraftplusModElements instance) {
		super(instance, 107);
	}
