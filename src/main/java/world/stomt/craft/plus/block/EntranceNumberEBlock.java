...
public class EntranceNumberEBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_e")
	public static final Block block = null;
	public EntranceNumberEBlock(StomtcraftplusModElements instance) {
		super(instance, 104);
	}
