...
public class EntranceNumberF2Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_f_2")
	public static final Block block = null;
	public EntranceNumberF2Block(StomtcraftplusModElements instance) {
		super(instance, 110);
	}
