...
public class EntranceNumberF3Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_f_3")
	public static final Block block = null;
	public EntranceNumberF3Block(StomtcraftplusModElements instance) {
		super(instance, 111);
	}
