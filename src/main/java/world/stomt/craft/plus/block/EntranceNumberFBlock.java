...
public class EntranceNumberFBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_f")
	public static final Block block = null;
	public EntranceNumberFBlock(StomtcraftplusModElements instance) {
		super(instance, 108);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("entrance_number_f");
		}
