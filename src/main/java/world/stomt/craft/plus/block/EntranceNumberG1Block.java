...
public class EntranceNumberG1Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_g_1")
	public static final Block block = null;
	public EntranceNumberG1Block(StomtcraftplusModElements instance) {
		super(instance, 113);
	}
