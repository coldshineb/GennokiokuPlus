...
public class EntranceNumberG2Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_g_2")
	public static final Block block = null;
	public EntranceNumberG2Block(StomtcraftplusModElements instance) {
		super(instance, 114);
	}
