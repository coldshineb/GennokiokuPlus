...
public class EntranceNumberG3Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_g_3")
	public static final Block block = null;
	public EntranceNumberG3Block(StomtcraftplusModElements instance) {
		super(instance, 115);
	}
