...
public class EntranceNumberGBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_g")
	public static final Block block = null;
	public EntranceNumberGBlock(StomtcraftplusModElements instance) {
		super(instance, 112);
	}
