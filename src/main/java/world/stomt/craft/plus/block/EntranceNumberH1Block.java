...
public class EntranceNumberH1Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_h_1")
	public static final Block block = null;
	public EntranceNumberH1Block(StomtcraftplusModElements instance) {
		super(instance, 117);
	}
