...
public class EntranceNumberH3Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_h_3")
	public static final Block block = null;
	public EntranceNumberH3Block(StomtcraftplusModElements instance) {
		super(instance, 119);
	}
