...
public class EntranceNumberHBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:entrance_number_h")
	public static final Block block = null;
	public EntranceNumberHBlock(StomtcraftplusModElements instance) {
		super(instance, 116);
	}
