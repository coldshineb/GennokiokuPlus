...
public class InterplanetaryMetroBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:interplanetary_metro")
	public static final Block block = null;
	public InterplanetaryMetroBlock(StomtcraftplusModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("interplanetary_metro");
		}
