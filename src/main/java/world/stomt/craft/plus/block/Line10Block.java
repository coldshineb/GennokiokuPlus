...
public class Line10Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:line10")
	public static final Block block = null;
	public Line10Block(StomtcraftplusModElements instance) {
		super(instance, 10);
	}
