...
public class Line1Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:line1")
	public static final Block block = null;
	public Line1Block(StomtcraftplusModElements instance) {
		super(instance, 1);
	}
