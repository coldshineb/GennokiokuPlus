...
public class Line2Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:line2")
	public static final Block block = null;
	public Line2Block(StomtcraftplusModElements instance) {
		super(instance, 2);
	}
