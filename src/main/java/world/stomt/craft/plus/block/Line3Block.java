...
public class Line3Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:line3")
	public static final Block block = null;
	public Line3Block(StomtcraftplusModElements instance) {
		super(instance, 3);
	}
