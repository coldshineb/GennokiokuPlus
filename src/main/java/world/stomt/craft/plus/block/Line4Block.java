...
public class Line4Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:line4")
	public static final Block block = null;
	public Line4Block(StomtcraftplusModElements instance) {
		super(instance, 4);
	}
