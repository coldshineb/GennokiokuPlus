...
public class Line5Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:line5")
	public static final Block block = null;
	public Line5Block(StomtcraftplusModElements instance) {
		super(instance, 5);
	}
