...
public class Line6Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:line6")
	public static final Block block = null;
	public Line6Block(StomtcraftplusModElements instance) {
		super(instance, 6);
	}
