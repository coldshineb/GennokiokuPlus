...
public class Line7Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:line7")
	public static final Block block = null;
	public Line7Block(StomtcraftplusModElements instance) {
		super(instance, 7);
	}
