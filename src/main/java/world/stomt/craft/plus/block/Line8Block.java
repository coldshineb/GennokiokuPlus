...
public class Line8Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:line8")
	public static final Block block = null;
	public Line8Block(StomtcraftplusModElements instance) {
		super(instance, 8);
	}
