...
public class Line9Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:line9")
	public static final Block block = null;
	public Line9Block(StomtcraftplusModElements instance) {
		super(instance, 9);
	}
