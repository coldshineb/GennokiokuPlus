...
public class LollipopColumnBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:lollipop_column")
	public static final Block block = null;
	public LollipopColumnBlock(StomtcraftplusModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lollipop_column");
		}
