...
public class PlatformSideLeft2Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:platform_side_left_2")
	public static final Block block = null;
	public PlatformSideLeft2Block(StomtcraftplusModElements instance) {
		super(instance, 18);
	}
