...
public class PlatformSideRight1Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:platform_side_right_1")
	public static final Block block = null;
	public PlatformSideRight1Block(StomtcraftplusModElements instance) {
		super(instance, 20);
	}
