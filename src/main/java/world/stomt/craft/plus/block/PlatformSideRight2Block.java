...
public class PlatformSideRight2Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:platform_side_right_2")
	public static final Block block = null;
	public PlatformSideRight2Block(StomtcraftplusModElements instance) {
		super(instance, 19);
	}
