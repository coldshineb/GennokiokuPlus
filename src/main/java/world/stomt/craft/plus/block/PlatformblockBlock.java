...
public class PlatformblockBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:platform_block")
	public static final Block block = null;
	public PlatformblockBlock(StomtcraftplusModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platform_block");
		}
