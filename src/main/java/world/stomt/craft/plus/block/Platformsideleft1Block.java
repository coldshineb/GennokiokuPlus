...
public class Platformsideleft1Block extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:platform_side_left_1")
	public static final Block block = null;
	public Platformsideleft1Block(StomtcraftplusModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("platform_side_left_1");
		}
