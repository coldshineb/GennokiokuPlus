...
public class RailwayTransitLogoBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:railway_transit_logo")
	public static final Block block = null;
	public RailwayTransitLogoBlock(StomtcraftplusModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("railway_transit_logo");
		}
