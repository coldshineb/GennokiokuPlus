...
public class ScreenDoorCoverDarkBlock extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:screen_door_cover_dark")
	public static final Block block = null;
	public ScreenDoorCoverDarkBlock(StomtcraftplusModElements instance) {
		super(instance, 23);
	}
