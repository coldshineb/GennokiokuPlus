...
package world.stomt.craft.plus.command;

import world.stomt.craft.plus.procedure.ProcedureCmdscpCommandExecuted;
		...
		public void execute(MinecraftServer server, ICommandSender sender, String[] cmd) {
			...
			if (entity != null) {
				...
				});
				{
					...
					ProcedureCmdscpCommandExecuted.executeProcedure($_dependencies);
				}
			}
		}
	}
