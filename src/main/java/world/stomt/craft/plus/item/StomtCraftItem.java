...
public class StomtCraftItem extends StomtcraftplusModElements.ModElement {
	@ObjectHolder("stomtcraftplus:stomtcraft")
	public static final Item block = null;
	public StomtCraftItem(StomtcraftplusModElements instance) {
		super(instance, 13);
	}
