 ...
 *
 *    Keep the ElementsStomtcraftplusMod object in this class and all calls to this object
...
public class StomtcraftplusMod {
	...
	public static final String VERSION = Info.STOMTCRAFT_VERSION_NUMBER;
	public static final SimpleNetworkWrapper PACKET_HANDLER = NetworkRegistry.INSTANCE.newSimpleChannel("stomtcraftplus:a");
	@SidedProxy(clientSide = "world.stomt.craft.stomtcraftplus.proxy.ClientProxy", serverSide = "world.stomt.craft.stomtcraftplus.proxy.ServerProxy")
	public static IProxyStomtcraftplusMod proxy;
	@Mod.Instance(MODID)
	public static StomtcraftplusMod instance;
	public ElementsStomtcraftplusMod elements = new ElementsStomtcraftplusMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsStomtcraftplusMod.GuiHandler());
