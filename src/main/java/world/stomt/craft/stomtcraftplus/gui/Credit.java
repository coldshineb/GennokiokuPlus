package world.stomt.craft.stomtcraftplus.gui;
...
public class Credit extends GuiScreen
{
    private static final Logger LOGGER = LogManager.getLogger();
    private static final ResourceLocation MINECRAFT_LOGO = new ResourceLocation("stomtcraftplus:textures/gui/title/minecraft.png");
    private static final ResourceLocation VIGNETTE_TEXTURE = new ResourceLocation("textures/misc/vignette.png");
    public static final ResourceLocation BACKGROUND = new ResourceLocation("stomtcraftplus:textures/gui/credit_background.png");
    ...
    public Credit(boolean poemIn, Runnable onFinishedIn)
    {
        this.poem = poemIn;
    ...
    public void initGui()
    {
        if (this.lines == null)
        {
            ...
            try
            {
                ...
                if (this.poem)
                {
                    iresource = this.mc.getResourceManager().getResource(new ResourceLocation("stomtcraftplus:textures/gui/title/credit.txt"));
                ...
                InputStream inputstream1 = this.mc.getResourceManager().getResource(new ResourceLocation("stomtcraftplus:textures/gui/title/credit.txt")).getInputStream();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawTexturedModalRect(j , k-40, 0, 30, 250, 200);
